...
class LoginForm(QtWidgets.QDialog, Background_Set):                     # 로그인 화면
    def __init__(self):                                 # 로그인 화면 셋팅
        ...
        pixmap = QtGui.QPixmap('/home/jin/darknet/The_latest_package/Data/Image/Logo.png')
...
class MainWindow(QtWidgets.QMainWindow, Background_Set):                # 기능선택 화면
    ...
    def setToolBar(self):                               # 툴바 셋팅
        exitAction = QtWidgets.QAction(QtGui.QIcon('/home/jin/darknet/The_latest_package/Data/Image/Toolbar/exit.png'), 'Exit', self)   # 툴바 아이콘 이미지 삽입
        ...
        logoutAction = QtWidgets.QAction(QtGui.QIcon('/home/jin/darknet/The_latest_package/Data/Image/Toolbar/logout.png'), 'Logout', self)
        ...
        trainAction = QtWidgets.QAction(QtGui.QIcon('/home/jin/darknet/The_latest_package/Data/Image/Toolbar/train_open.png'), 'Train', self)
        ...
        videoAction = QtWidgets.QAction(QtGui.QIcon('/home/jin/darknet/The_latest_package/Data/Image/Toolbar/video_open.png'), 'Video', self)
        ...
        stratAction = QtWidgets.QAction(QtGui.QIcon('/home/jin/darknet/The_latest_package/Data/Image/Toolbar/play.png'), 'Start', self)
...
class Cam_Btn_Set():                                                    # Cam 조작 화면 버튼
    def cam_btn_set(self, camera):                      # Cam 조작 버튼 셋팅
        ...
        self.button_Auto.setStyleSheet("background-image: url('/home/jin/darknet/The_latest_package/Data/Image/controller_btn/joypad.png'); border: none;")
        ...
        self.button_Finder.setStyleSheet("background-image: url('/home/jin/darknet/The_latest_package/Data/Image/controller_btn/finder.png'); border: none;")
        ...
        self.button_Cap.setStyleSheet("background-image: url('/home/jin/darknet/The_latest_package/Data/Image/controller_btn/capture.png'); border: none;")
        ...
        self.button_REC.setStyleSheet("background-image: url('/home/jin/darknet/The_latest_package/Data/Image/controller_btn/REC.png'); border: none;")
        ...
        self.button_Exit.setStyleSheet("background-image: url('/home/jin/darknet/The_latest_package/Data/Image/controller_btn/exit.png'); border: none;")
    ...
    def rec(self):                                      # Video 녹화 시작/중지
        if self.start_btn_status == 0:
            self.button_REC.setStyleSheet("background-image: url('/home/jin/darknet/The_latest_package/Data/Image/controller_btn/STOP.png'); border: none;")
...
class Video_Btn_Set():                                                  # Video 조작 화면 버튼
    def video_btn_set(self, camera):                            # Video 조작 버튼 셋팅
        ...
        self.button_video_speed_down.setStyleSheet("background-image: url('/home/jin/darknet/The_latest_package/Data/Image/controller_btn/minor10.png'); border: none;")
        ...
        self.button_video_speed_up.setStyleSheet("background-image: url('/home/jin/darknet/The_latest_package/Data/Image/controller_btn/plus10.png'); border: none;")
        ...
        self.button_Video_Start.setStyleSheet("background-image: url('/home/jin/darknet/The_latest_package/Data/Image/controller_btn/pause_b.png'); border: none;")
    ...
    def video_start_stop(self):                         # Video 녹화 시작
        if self.start_btn_status == 0:
            self.button_Video_Start.setStyleSheet("background-image: url('/home/jin/darknet/The_latest_package/Data/Image/controller_btn/play.png'); border: none;")
            self.pause= True
...
class Normal_Video(QtWidgets.QDialog, Video_Btn_Set, Background_Set):   # Only Video 조작 화면
    def __init__(self):                                 # Video 화면 셋팅
        ...
        self.button_Finder.setStyleSheet("background-image: url('/home/jin/darknet/The_latest_package/Data/Image/controller_btn/finder_none.png'); border: none;")
        self.show()
        self.video_convert()
...
class Camera_Control(QtWidgets.QDialog, Background_Set):                # Cam 수동조작 & 방향키
    def __init__(self, camera):                         # Cam 수동조작 화면 셋팅
        ...
        self.button_Up = QtWidgets.QPushButton(QtGui.QIcon('/home/jin/darknet/The_latest_package/Data/Image/Controller/up.png'),'', self)
        ...
        self.button_Down = QtWidgets.QPushButton(QtGui.QIcon('/home/jin/darknet/The_latest_package/Data/Image/Controller/down.png'),'', self)
        ...
        self.button_Right = QtWidgets.QPushButton(QtGui.QIcon('/home/jin/darknet/The_latest_package/Data/Image/Controller/right.png'),'', self)
        ...
        self.button_Left = QtWidgets.QPushButton(QtGui.QIcon('/home/jin/darknet/The_latest_package/Data/Image/Controller/left.png'),'', self)
