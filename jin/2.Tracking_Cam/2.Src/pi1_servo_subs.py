...
class Servo_Subscriber():
    def __init__(self):
        self.Servo_subs = rospy.Subscriber('/Servo_Cam1', UInt16MultiArray, self.callback, queue_size=1) # 객체인식 바운딩박스 x,y,w,h 토픽
        self._Manual_subs = rospy.Subscriber('/manual_control1', Int8MultiArray, self.callback1, queue_size=1)
