...
class LoginForm(QtWidgets.QWidget):
    def __init__(self):
        ...
        layout.addWidget(self.button_login, 5, 0, 1, 2)
...
class Tracking_Video(QtWidgets.QDialog, QtWidgets.QWidget):
    def __init__(self):
